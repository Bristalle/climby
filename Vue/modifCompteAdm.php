...
// Selection de la barre de navigation
session_start();
$barre = "barreVisiteur";
...
$formUser = '
	<form method="post" action="modifCompteAdm2.php">
...
<div class ="container">
	...
	<div class ="bloc-2">
		<div class="page-header">
            ...
            <div class="info">
                <form method="post" action="./../Site.php?a=modifCompteAdmin">
                <?php
				// Affichage du contenu du nouveau formulaire si reçu
                if(isset($_GET['a'])){
                    echo $_GET['a'];
                }
                ?>
